...
namespace puantaj2017.DAL
{
    public class UrlCacheProgram
    {
        ...
        [DllImport("wininet.dll", SetLastError = true)]
        public static extern long FindNextUrlCacheEntry(IntPtr hEnumHandle, IntPtr lpNextCacheEntryInfo,
        ...
        public static string GetPathForCachedFile(string fileUrl)
        {
            ...
            try
            {
                ...
                if (result == true)
                {
                    ...
                    String localFileName = Marshal.PtrToStringAuto(internetCacheEntry.lpszLocalFileName);
